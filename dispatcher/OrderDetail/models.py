...
class OrderDetail(models.Model):
    ...
    createTime = DateTimeField(auto_now=False, null=True)
    departTime = DateTimeField(auto_now=False, null=True)
    pickupTime = DateTimeField(auto_now=False, null=True)
    completeTime = DateTimeField(auto_now=False, null=True)
